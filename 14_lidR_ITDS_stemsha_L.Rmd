...
las_tile_ahbau_ttops_sf = st_as_sf(las_tile_ahbau_ttops, coords = c("x","y")) %>%
  st_set_crs(defaultCRS)
las_tile_ahbau_ttops_matrix <- unlist(st_geometry(las_tile_ahbau_ttops_sf)) %>% 
  matrix(ncol=2,byrow=TRUE) 
las_tile_ahbau_ttops_stemsha_L <- pointdensity(las_tile_ahbau_ttops_matrix, eps = 0.00000001784, type = "density")
